...
function changeQuestion(direction) {
  ...
  document.getElementById("qNum").textContent =
    "Question No. " + (parseInt(currentQuestionIndex) + 1);
}
const scriptURL =
  "https://script.google.com/macros/s/AKfycbzrysbkVOvpCu2GEPKGuSE0tg3gTOMgICJrgZukHZgMk-fPRMam9yPfs2yCbTubT5A8/exec?sheetName=Result";
